...
package object drivetrain {
  ...
  type TurnVelocityGains = PIDConfig[AngularVelocity, GenericValue[AngularVelocity], AngularVelocity, GenericDerivative[
    AngularVelocity
  ], Angle, Dimensionless]

  type ForwardPositionGains =
    PIDConfig[Length, Length, GenericValue[Length], Velocity, GenericIntegral[Length], Dimensionless]

  type TurnPositionGains =
