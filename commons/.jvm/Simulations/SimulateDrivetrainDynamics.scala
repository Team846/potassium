...
class SimulateDrivetrainDynamics extends FunSuite {
  implicit val props = Signal.constant(new TwoSidedDriveProperties {
    ...
    override val leftControlGains = forwardControlGains
    override val rightControlGains = forwardControlGains
  })
  ...
  test("Test drive forward controller oscilates about end point") {
    ...
    implicit val drivetrainContainer = new TwoSidedDrivePackageSimulator(Milliseconds(5))
