...
class LEDController(val coreTicks: Stream[Unit], val alliance: Signal[DriverStation.Alliance])(implicit hardware: LEDControllerHardware) extends Component[Color]{
