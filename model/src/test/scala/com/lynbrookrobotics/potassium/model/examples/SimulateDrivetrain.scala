...
object SimulateDrivetrain extends App {
  ...
  val task = new drivetrainContainer.unicycleTasks.FollowWayPoints(Point.origin :: Point(Feet(0), Feet(5)) :: Point(Feet(5), Feet(10)) :: Nil, Inches(5), Percent(70))(simulatedComponent)()
